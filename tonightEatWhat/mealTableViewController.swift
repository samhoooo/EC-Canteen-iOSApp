...
class mealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let alert = UIAlertController(title: "加到購物籃", message: "你確家定要加 "+meals[indexPath.row].name+" 到購物籃嗎？", preferredStyle: UIAlertControllerStyle.actionSheet)
        alert.addAction(UIAlertAction(title: "是", style: UIAlertActionStyle.default, handler: {_ in
                var mealItem = self.meals[indexPath.row]
